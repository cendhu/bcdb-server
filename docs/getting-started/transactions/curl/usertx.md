...
Next, we will see an example for
  1. [Addition of Users](#addition-of-a-user)
  2. [Updation of Users](#updation-of-a-user)
  3. [Deletion of Users](#deletion-of-a-user)
...
### Remove all privileges of `alice`
...
### Check the non-existence of the user `alice`
