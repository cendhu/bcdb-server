	...
	testCases := []struct {
		...
		},
		{
			...
			expectedIndexEntries: map[string]*worldstate.DBUpdates{
				IndexDBPrefix + "db1": {
					Writes: []*worldstate.KVWithMetadata{
						{
							Key: `{"a":"a1","t":1,"m":"` + PositiveNumber + `","vp":1,"v":"` + encoded10 + `","kp":1,"k":"person1"}`,
						},
						{
							Key: `{"a":"a2","t":2,"m":"","vp":1,"v":"ten","kp":1,"k":"person1"}`,
						},
						{
							Key: `{"a":"a3","t":3,"m":"","vp":1,"v":true,"kp":1,"k":"person1"}`,
						},
					},
				},
				IndexDBPrefix + "db2": {
					Writes: []*worldstate.KVWithMetadata{
						{
							Key: `{"a":"a2","t":2,"m":"","vp":1,"v":"eleven","kp":1,"k":"person2"}`,
						},
					},
				},
			},
			...
			expectedIndexEntries: map[string]*worldstate.DBUpdates{
				IndexDBPrefix + "db1": {
					Writes: []*worldstate.KVWithMetadata{
						...
						{
							Key: `{"a":"a2","t":2,"m":"","vp":1,"v":"10","kp":1,"k":"person1"}`,
						},
					},
					Deletes: []string{
						`{"a":"a3","t":3,"m":"","vp":1,"v":false,"kp":1,"k":"person1"}`,
						`{"a":"a2","t":2,"m":"","vp":1,"v":"ten","kp":1,"k":"person1"}`,
					},
				},
				IndexDBPrefix + "db2": {
					Writes: []*worldstate.KVWithMetadata{
					...
					Deletes: []string{
						`{"a":"a2","t":2,"m":"","vp":1,"v":"ten","kp":1,"k":"person2"}`,
					},
				},
			},
		},
		{
			...
			expectedIndexEntries: map[string]*worldstate.DBUpdates{
				IndexDBPrefix + "db1": {
					Deletes: []string{
						`{"a":"a1","t":1,"m":"` + PositiveNumber + `","vp":1,"v":"` + encoded10 + `","kp":1,"k":"person1"}`,
						`{"a":"a2","t":2,"m":"","vp":1,"v":"ten","kp":1,"k":"person1"}`,
						`{"a":"a3","t":3,"m":"","vp":1,"v":true,"kp":1,"k":"person1"}`,
					},
				},
				IndexDBPrefix + "db2": {
					Deletes: []string{
						`{"a":"a2","t":2,"m":"","vp":1,"v":"eleven","kp":1,"k":"person2"}`,
					},
				},
			},
		},
...
func TestRemoveDuplicateIndexEntries(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			name: "no duplicates",
			indexOfNewValues: []string{
				`{"a":"age","t":1,"vp":1,"v":25,"kp":1,"k":"person1"}`,
				`{"a":"age","t":1,"vp":1,"v":25,"kp":1,"k":"person2"}`,
				`{"a":"age","t":1,"vp":1,"v":26,"kp":1,"k":"person3"}`,
			},
			indexOfExistingValues: []string{
				`{"a":"age","t":1,"vp":1,"v":26,"kp":1,"k":"person1"}`,
				`{"a":"age","t":1,"vp":1,"v":27,"kp":1,"k":"person2"}`,
				`{"a":"age","t":1,"vp":1,"v":28,"kp":1,"k":"person3"}`,
			},
			expectedIndexOfNewValues: []string{
				`{"a":"age","t":1,"vp":1,"v":25,"kp":1,"k":"person1"}`,
				`{"a":"age","t":1,"vp":1,"v":25,"kp":1,"k":"person2"}`,
